...
const getLivros = function(nomeDoLivro){
    //Recebe a variavel do nome do livro e converte para
        //MAIUSCULO 
    ...
    livros.biblioteca.forEach(function(item){
        ...
        item.books.forEach(function(livro){
            ...
            if(livro.title.toUpperCase().includes(nome)){
                ...
                //Sinaliza que algum livro foi encontrado na buca
                status = true;
            }
        })
    });
    //Se algum livro foi encontrado, retorna os dados
    if (status){
        //Cria um atributo de "quantidade_livros" para retornar a 
        //qtde de livros enconttrados
        jsonDadosLivros.quantidade_livros = arrayLivros.length;
        //Cria um um atributo "livros" para retornar o array de livros
